...
KNN (igual al z2.4.6 solo q KNN)
cambiamos de similarity coefficient, esta vez sin popularity sumando y agrupando sobre los 100 usuarios mas similes
@author: cecibloom
"""
...
print ('Executing z2.4.7.py at ', datetime.datetime.now())
...
def getRecommendations(target_user_id) :
    ...
    user_similars_to_me = pd.DataFrame(similarities[similarities['user_a_id'] == target_user_id]).sort_values('jaccard_index',ascending=False)[:50]
