...
print ('Executing z2.4.2py at ', datetime.datetime.now())
...
def getRecommendations(target_user_id) :
    ...
    #jobs_similar_users = interactions_of_users
    ...
    best_rated_items_among_users_similar_to_me = jobs_similar_users[:10]
